...
const StartPage = () => {
  ...
  if (keycloak.authenticated)
    return <Navigate to="/timeline"></Navigate>
  //
  ...
  return (
    <div className="backgroundcolorMain  -ml-96  max-w-screen">
      <div className="flex justify-center mr-48 h-screen">
        ...
        <div className="flex items-center w-full max-w-md -mr-24 px-20 mx-auto lg:w-2/6">
          <div className="flex-2">
            <div className="text-center">
              ...
              <p className="mt-3 text-gray-700 ">
                Sign in using keycloak to access your account
              </p>
            </div>
