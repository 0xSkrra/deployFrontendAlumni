...
import {
  defaultUserProfile,
  UserProfile,
} from "../../common/interface/UserProfile"
...
const AccountPage = () => {
  ...
  return (
    <div className=" h-6/6 flex flex-row justify-center rounded-lg ">
      <div className="flex flex-col w-5/6 break-words bg-white w-full mb-6 shadow-xl rounded-lg mt-16">
        <div className="px-6  ">
          <div className="flex flex-wrap justify-center">
            ...
            <div className="w-full px-4 text-center mt-20">
              <div className="flex justify-center">
                ...
                <div className="mr-4 p-3 text-center">
                  <span className="text-xl font-bold block uppercase tracking-wide text-blueGray-600">
                    {user.authoredEvents.length +
                      user.respondedEvents.length}
                  </span>
                  <span className="text-sm text-blueGray-400">
                    Events
                  </span>
