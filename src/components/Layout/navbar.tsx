...
const Navbar = () => {
  ...
  return (
    <aside className="lg:w-96 flex-col md:min-w-65 hidden md:flex h-screen px-4 py-1 bg-white sm:border-t md:border-r">
      <g transform="translate(141.94 152.429)">
        <svg
          viewBox="0 0 356.121 95.142"
          height="95.142"
          width="356.121"
        >
          <svg
          ...
          >
            ...
            >
              <path
                d="M0 95.142V0h356.121v95.142z"
                fill="#4b97b3"
                data-fill-palette-color="tertiary"
              />
              <path
                d="M3.283 91.859V3.283h349.554v88.576z"
                fill="#fff"
                data-fill-palette-color="quaternary"
              />
              <path
                d="M9.85 85.293V9.85h336.421v75.443z"
                fill="#4b97b3"
                data-fill-palette-color="tertiary"
              />
              <g transform="translate(19.7 19.7)">
                <svg
                  viewBox="0 0 316.721 55.743"
                  height="55.743"
                  width="316.721"
                >
                  <svg
