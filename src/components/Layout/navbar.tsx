...
const Navbar = () => {
  ...
  return (
    <aside className="lg:w-96 flex-col md:min-w-65 hidden md:flex h-screen  py-1 bg-white sm:border-t md:border-r">
      <g
        id="tight-bounds"
        transform="matrix(1,0,0,1,122.24000000000001,160.80589347417234)"
      >
        <svg
          viewBox="0 0 395.52 78.38821305165533"
          height="58.38821305165533"
          width="395.52"
        >
          <g>
            <svg
              viewBox="0 0 531.4095592673476 105.32020062079063"
              height="78.38821305165533"
              width="395.52"
            >
              <g transform="matrix(1,0,0,1,0,14.555830910688144)">
                <svg
                  viewBox="0 0 395.5199999999999 76.20853879941434"
                  height="76.20853879941434"
              ...
              <g transform="matrix(1,0,0,1,413.51100700561045,0)">
                <svg
                  viewBox="0 0 117.89855226173715 105.32020062079063"
                  height="105.32020062079063"
                  width="117.89855226173715"
                >
                  <g>
                    <svg
                      ...
                      x="0"
                      y="0"
                      viewBox="5.000076770782471 9.801164627075195 89.99971771240234 80.39783477783203"
