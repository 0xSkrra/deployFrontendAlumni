  ...
  <aside className="lg:w-96 flex-col md:min-w-65 hidden md:flex h-screen px-4 py-8 bg-white sm:border-t md:border-r">
    ...
    <div className="flex flex-col justify-between flex-1 mt-6">
        <nav>
            ...
            <a className="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-300 transform rounded-md hover:bg-gray-200 hover:text-gray-700" href="#">
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="flex items-center px-4 py-2 transition-colors duration-300 transform rounded-md hover:bg-gray-200 hover:cursor-pointer">
