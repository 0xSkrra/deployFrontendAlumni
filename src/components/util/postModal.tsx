...
const PostModal = ({
  ...
  return (
    <div
      className="absolute transition bg-gray-100 ease-in-out delay-150 h-screen duration-300 top-0 left-[25%] bottom-0 w-full max-w-[53%] py-50 shadow-md overflow-x-hidden overflow-y-auto"
      id="exampleModalFullscreen"
      aria-labelledby="exampleModalFullscreenLabel"
    >
      <div className="modal-dialog min-h-[100%] modal-fullscreen  relative w-auto pointer-events-none">
        <div className="modal-content border-l border-r bg-gray-100 h-screen relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding rounded-md outline-none text-current">
                ...
                <div className="mb-4 w-full bg-gray-100 rounded-lg border-2 border-gray-300">
                  <div className="py-2 px-4 bg-gray-100 rounded-t-lg ">
                    ...
                    <textarea
                      ...
                      rows={4}
                      className="p-2  outline-0 border-b border-gray-200  w-full text-sm text-gray-900 bg-gray-100"
