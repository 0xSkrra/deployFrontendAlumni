            ...
            <div className='p-0 w-15 shadow-lg rounded-lg bg-slate-50' >
                ...
                <div className='border-2 border-gray-100 h-50 rounded-lg hoverColorCard hover:border-gray-300 hover:cursor-pointer transition-all duration-200' onClick={navigateToProp}>
                    ...
                    <div className='text-center'>
                        {!membership && 
                        <button disabled={loadingbutton} className='inline-flex text-left text-green-700 fill-green-700 align-bottom m-2 px-5 py-2 rounded-md  border-2 text-color border-green-700 hoverColor hover:text-white hover:fill-white'  
                        onClick={() => {handleClick()}}>
