...
const ListRow = (props: any) => {
  ...
  return (
    <div className="p-0 w-15 shadow-lg rounded-lg bg-slate-50">
      <div>
        <div
          className="border-2 border-gray-100 h-50 rounded-lg hoverColorCard hover:border-gray-300 hover:cursor-pointer transition-all duration-200"
          onClick={navigateToProp}
        >
          <div className="list-desc">
            <h2 className="font-bold text-xl mb-2 mx-2 text-center">
              {props.el.title}
            </h2>
            <div className="inline-flex ml-2">
              ...
              {props.el.users.length !== 1 && (
                <span className="text-left justify-start ml-2">
        ...
        <div className="text-center">
          {!membership && (
            <button
              ...
              className="inline-flex text-left text-green-700 fill-green-700 align-bottom m-2 px-5 py-2 rounded-md  border-2 text-color border-green-700 hoverColor hover:text-white hover:fill-white transition-all duration-200"
              onClick={() => {
                handleClick()
              }}
            >
              ...
              {!loadingbutton ? (
                <span className="pl-2 font-medium ">Join</span>
              ) : (
                <span>loading...</span>
              )}
            </button>
          ...
          {membership && (
            <button
              disabled={loadingbutton}
              className="inline-flex text-left text-red-700 fill-red-700 align-bottom m-2 px-5 py-2 rounded-md  border-2  text-color border-red-700 hoverColor2 hover:text-white hover:fill-white transition-all duration-200"
              onClick={() => {
                handleLeave()
              }}
            >
              ...
              {!loadingbutton ? (
                <span className="pl-2 font-medium ">Leave</span>
              ) : (
                <span>loading...</span>
              )}
            </button>
